...
//void makeAnalyticsRestRequest(utility::string_t analyticsUrl, utility::string_t analyticsKeyHeader, utility::string_t analyticsAccHeader, json::value jsonPayload) {
